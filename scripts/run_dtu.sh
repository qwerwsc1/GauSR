...
do
    # python train.py -s ${dataset_folder}/scan${scene} -m /media/data/SurR/outputs/gausr/dtu/scan${scene} -r 2
    python mesh_extract.py -m /media/data/SurR/outputs/gausr/dtu/scan${scene}
    python scripts/eval_dtu/evaluate_dtu_mesh.py -m /media/data/SurR/outputs/gausr/dtu/scan${scene}
done