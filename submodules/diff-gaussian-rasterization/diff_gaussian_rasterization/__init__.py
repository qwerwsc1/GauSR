...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, alpha, normal, depth, mdepth, radii, geomBuffer, binningBuffer, imgBuffer, tileBuffer = _C.rasterize_gaussians(*args)
        ...
        ctx.save_for_backward(colors_precomp, opacities, means3D, scales, rotations, cov3Ds_precomp, normal, radii, sh, geomBuffer, binningBuffer, imgBuffer, tileBuffer, alpha)
    ...
    def backward(ctx, grad_color, grad_radii, grad_depth, grad_mdepth, grad_alpha, grad_normal):
        ...
        colors_precomp, opacities, means3D, scales, rotations, cov3Ds_precomp, normal, radii, sh, geomBuffer, binningBuffer, imgBuffer, tileBuffer, alpha = ctx.saved_tensors
